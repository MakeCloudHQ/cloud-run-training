...
1. [Projects and Folders](./01-projects-and-folders.md) - Organizational hierarchy
2. [Networking](./02-networking.md) - VPCs, subnets, and connectivity basics
3. [IAM (Identity and Access Management)](./03-iam.md) - Roles and permissions
4. [Discussion Topics](./04-discussion-topics.md) - Common questions and scenarios

## Format

This section will be interactive with:
- Brief presentations on each topic
- Console/CLI demonstrations
